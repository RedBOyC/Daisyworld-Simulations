...
Original file is located at
    https://colab.research.google.com/drive/1Nhn4M1AKwNBHMepDN0MMtTN7A7ZzXMUV
"""
...
"""##constants in the entire article"""
...
q_prime=20 #from figure 1, helps to calculate the local temperature as funct of local albedo
P=1.0 #from figure 1, proportion of the area with fertile ground
gamma=0.3 #from figure 1, death rate per unit time
